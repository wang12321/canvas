...
export default {
  ...
  methods: {
    ...
    jianbjx() {
      ...
      cxt.closePath()
      // 渐变
      const gnt = cxt.createRadialGradient(100, 60, 15, 80, 80, 50)
      ...
      let gradient = cxt.createRadialGradient(260, 60, 0, 260, 60, 60)
    ...
    jianb() {
      ...
      const gnt1 = cxt.createLinearGradient(0, 160, 200, 310)
      gnt1.addColorStop(0, 'HotPink')
      gnt1.addColorStop(1, 'green')
      cxt.fillStyle = gnt1
      cxt.fillRect(0, 160, 200, 150)

      const gnt2 = cxt.createLinearGradient(200, 0, 200, 150)
      gnt2.addColorStop(0, 'HotPink')
      gnt2.addColorStop(1, 'green')
      cxt.fillStyle = gnt2
      cxt.fillRect(210, 0, 200, 150)

      const gnt3 = cxt.createLinearGradient(210, 310, 400, 160)
      gnt3.addColorStop(0, 'HotPink')
